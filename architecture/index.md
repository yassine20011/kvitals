...
1. **Stable File Descriptors**: No CLI pipes need to be kept open, eliminating Plasma 6 Wayland FD-exhaustion crashes.
1. **Low Latency**: The widget reads the exact same backend API as the official KDE System Monitor.
